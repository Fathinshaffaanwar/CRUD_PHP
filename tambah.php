	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO mahasiswa(nim, nama, jenis_kelamin, id_dosen) VALUES('$nim', '$nama', '$jenis_kelamin', '$id_dosen')") or die(mysqli_error($koneksi));
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="id_dosen" class="form-control" required>
						...
						<option value=12001>Prof. Dr Taufik Fuadi Abidin S.Si., M.Tech</option>
						<option value=12002>Arie Budiansyah ST., M.Eng.</option>
						<option value=12003>Rasudin S.Si., M.Info. Tech</option>
                        <option value=12004>Dalila Husna Yunardi B.Sc., M.Sc.</option>
                        <option value=12005>Viska Mutiawani, M.IT</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
